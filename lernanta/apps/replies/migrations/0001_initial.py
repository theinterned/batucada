...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('replies_pagecomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('richtext.models.RichTextField')(blank='False')),
            ...
            ('reply_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='replies', null=True, to=orm['replies.PageComment'])),
            ('abs_reply_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='all_replies', null=True, to=orm['replies.PageComment'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('replies', ['PageComment'])


    def backwards(self, orm):
        
        # Deleting model 'PageComment'
        db.delete_table('replies_pagecomment')
