...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageComment.reply_token'
        db.add_column('replies_pagecomment', 'reply_token', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageComment.reply_token'
        db.delete_column('replies_pagecomment', 'reply_token')
    ...
    models = {
        ...
        'replies.pagecomment': {
            ...
            'reply_token': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
