...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageComment.sent_by_email'
        db.add_column('replies_pagecomment', 'sent_by_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageComment.sent_by_email'
        db.delete_column('replies_pagecomment', 'sent_by_email')
    ...
    models = {
        ...
        'replies.pagecomment': {
            ...
            'sent_by_email': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'taggit.tag': {
