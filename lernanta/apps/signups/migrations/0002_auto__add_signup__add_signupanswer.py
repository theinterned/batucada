...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('signups_signup', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sign_up', to=orm['projects.Project'])),
            ('public', self.gf('richtext.models.RichTextField')(blank=True)),
            ('between_participants', self.gf('richtext.models.RichTextField')(blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='moderated', max_length=30, null=True)),
        ))
        db.send_create_signal('signups', ['Signup'])

        # Adding model 'SignupAnswer'
        db.create_table('signups_signupanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sign_up', self.gf('django.db.models.fields.related.ForeignKey')(related_name='answers', to=orm['signups.Signup'])),
            ('standard', self.gf('richtext.models.RichTextField')()),
            ('public', self.gf('richtext.models.RichTextField')(blank=True)),
            ('between_participants', self.gf('richtext.models.RichTextField')(blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sigup_answers', to=orm['users.UserProfile'])),
        ...
        db.send_create_signal('signups', ['SignupAnswer'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SignupAnswer'
        db.delete_table('signups_signupanswer')
    ...
    models = {
        ...
        'signups.signup': {
            ...
            'between_participants': ('richtext.models.RichTextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sign_up'", 'to': "orm['projects.Project']"}),
            'public': ('richtext.models.RichTextField', [], {'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'moderated'", 'max_length': '30', 'null': 'True'})
        },
        'signups.signupanswer': {
            'Meta': {'object_name': 'SignupAnswer'},
            'accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sigup_answers'", 'to': "orm['users.UserProfile']"}),
            'between_participants': ('richtext.models.RichTextField', [], {'blank': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'public': ('richtext.models.RichTextField', [], {'blank': 'True'}),
            'sign_up': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'answers'", 'to': "orm['signups.Signup']"}),
            'standard': ('richtext.models.RichTextField', [], {})
        },
        'taggit.tag': {
