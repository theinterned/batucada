...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reviews_review', 'content', self.gf('richtext.models.RichTextField')(default='', blank='False'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.content'
        db.delete_column('reviews_review', 'content')
