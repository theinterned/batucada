...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reviews_review', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='reviews', to=orm['users.UserProfile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.author'
        db.delete_column('reviews_review', 'author_id')
