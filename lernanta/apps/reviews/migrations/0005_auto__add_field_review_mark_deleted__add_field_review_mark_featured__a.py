...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.mark_deleted'
        db.add_column('reviews_review', 'mark_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Review.mark_featured'
        db.add_column('reviews_review', 'mark_featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Reviewer.can_delete'
        db.add_column('reviews_reviewer', 'can_delete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Reviewer.can_feature'
        db.add_column('reviews_reviewer', 'can_feature', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.mark_deleted'
        db.delete_column('reviews_review', 'mark_deleted')

        # Deleting field 'Review.mark_featured'
        db.delete_column('reviews_review', 'mark_featured')

        # Deleting field 'Reviewer.can_delete'
        db.delete_column('reviews_reviewer', 'can_delete')

        # Deleting field 'Reviewer.can_feature'
        db.delete_column('reviews_reviewer', 'can_feature')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'completion_badges': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'projects_completion'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['badges.Badge']"}),
        ...
        'reviews.review': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reviews'", 'to': "orm['users.UserProfile']"}),
            'content': ('richtext.models.RichTextField', [], {}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mark_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mark_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reviews'", 'to': "orm['projects.Project']"})
        },
        'reviews.reviewer': {
            'Meta': {'object_name': 'Reviewer'},
            'can_delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'can_feature': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
