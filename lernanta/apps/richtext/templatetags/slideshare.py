...
SLIDESHARE_RE = (r"\[slideshare:http://static.slidesharecdn.com/swf/" +
    r"(?P<url>.+\?doc=[A-Za-z0-9\-=_]+)(&.*)?\]")
SLIDESHARE_EMBED = """
<embed allowfullscreen="true" height="355" name="__sse7328741"
src="http://static.slidesharecdn.com/swf/%s"
