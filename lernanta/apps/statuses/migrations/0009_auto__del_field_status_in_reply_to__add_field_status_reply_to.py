...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.reply_to'
        db.add_column('statuses_status', 'reply_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='status_replies', null=True, to=orm['activity.Activity']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Status.in_reply_to'
        db.add_column('statuses_status', 'in_reply_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='replies', null=True, to=orm['activity.Activity'], blank=True), keep_default=False)

        # Deleting field 'Status.reply_to'
        db.delete_column('statuses_status', 'reply_to_id')
    ...
    models = {
        ...
        'statuses.status': {
            ...
            'reply_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'status_replies'", 'null': 'True', 'to': "orm['activity.Activity']"}),
