...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('statuses_status', 'status', self.gf('richtext.models.RichTextField')())


    def backwards(self, orm):
        
        # Changing field 'Status.status'
        db.alter_column('statuses_status', 'status', self.gf('django.db.models.fields.TextField')())
