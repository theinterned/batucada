...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BadgeSubmissionAnswer.text'
        db.add_column('badges_badgesubmissionanswer', 'text', self.gf('richtext.models.RichTextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BadgeSubmissionAnswer.text'
        db.delete_column('badges_badgesubmissionanswer', 'text')
    ...
    models = {
        ...
        'badges.badgesubmissionanswer': {
            ...
            'text': ('richtext.models.RichTextField', [], {})
        },
        'badges.logic': {
