...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rating.assessment'
        db.add_column('badges_rating', 'assessment', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ratings', to=orm['badges.Assessment']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Rating.assessment'
        db.delete_column('badges_rating', 'assessment_id')
    ...
    models = {
        ...
        'badges.assessment': {
            ...
            'final_rating': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
