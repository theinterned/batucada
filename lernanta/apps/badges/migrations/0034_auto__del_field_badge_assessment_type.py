...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Badge.assessment_type'
        db.delete_column('badges_badge', 'assessment_type')


    def backwards(self, orm):
        
        # Adding field 'Badge.assessment_type'
        db.add_column('badges_badge', 'assessment_type', self.gf('django.db.models.fields.CharField')(default='self', max_length=30, null=True), keep_default=False)
