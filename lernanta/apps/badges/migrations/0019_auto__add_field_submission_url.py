...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('badges_submission', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=1023), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.url'
        db.delete_column('badges_submission', 'url')
