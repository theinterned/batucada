...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Rating.assessor'
        db.delete_column('badges_rating', 'assessor_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Rating.assessor'
        raise RuntimeError("Cannot reverse this migration. 'Rating.assessor' and its values cannot be restored.")
