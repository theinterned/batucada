...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Logic.name'
        db.alter_column('badges_logic', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'Logic.name'
        db.alter_column('badges_logic', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
