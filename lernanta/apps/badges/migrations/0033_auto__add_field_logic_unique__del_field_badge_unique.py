...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Logic.unique'
        db.add_column('badges_logic', 'unique', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Badge.unique'
        db.delete_column('badges_badge', 'unique')


    def backwards(self, orm):
        
        # Deleting field 'Logic.unique'
        db.delete_column('badges_logic', 'unique')

        # Adding field 'Badge.unique'
        db.add_column('badges_badge', 'unique', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
