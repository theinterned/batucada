...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Logic.submission_style'
        db.add_column('badges_logic', 'submission_style', self.gf('django.db.models.fields.CharField')(default='no_submissions', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Logic.submission_style'
        db.delete_column('badges_logic', 'submission_style')
