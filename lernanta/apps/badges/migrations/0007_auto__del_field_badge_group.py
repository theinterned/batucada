...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Badge.group'
        db.delete_column('badges_badge', 'group_id')

        # Adding M2M table for field groups on 'Badge'
        db.create_table('badges_badge_groups', (
        ...
        db.create_unique('badges_badge_groups', ['badge_id', 'project_id'])


    def backwards(self, orm):
        
        # Adding field 'Badge.group'
        db.add_column('badges_badge', 'group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='badges', null=True, to=orm['projects.Project'], blank=True), keep_default=False)

        # Removing M2M table for field groups on 'Badge'
        db.delete_table('badges_badge_groups')
