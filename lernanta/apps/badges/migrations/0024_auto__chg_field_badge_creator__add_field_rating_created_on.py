...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.creator'
        db.alter_column('badges_badge', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.UserProfile']))

        # Adding field 'Rating.created_on'
        db.add_column('badges_rating', 'created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Badge.creator'
        db.alter_column('badges_badge', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.UserProfile']))

        # Deleting field 'Rating.created_on'
        db.delete_column('badges_rating', 'created_on')
