...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Badge.badge_type'
        db.delete_column('badges_badge', 'badge_type')


    def backwards(self, orm):
        
        # Adding field 'Badge.badge_type'
        db.add_column('badges_badge', 'badge_type', self.gf('django.db.models.fields.CharField')(default='completion/aggregate', max_length=30, null=True), keep_default=False)
