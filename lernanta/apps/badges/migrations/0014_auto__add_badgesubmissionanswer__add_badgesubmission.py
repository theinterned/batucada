...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'badges.badgesubmission': {
            'Meta': {'object_name': 'BadgeSubmission'},
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'badge_application'", 'to': "orm['badges.Badge']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'badge_application'", 'to': "orm['projects.Project']"})
        },
        'badges.badgesubmissionanswer': {
            'Meta': {'object_name': 'BadgeSubmissionAnswer'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submissions'", 'to': "orm['badges.BadgeSubmission']"})
        },
        'badges.logic': {
