...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assessment.final_rating'
        db.add_column('badges_assessment', 'final_rating', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assessment.final_rating'
        db.delete_column('badges_assessment', 'final_rating')
