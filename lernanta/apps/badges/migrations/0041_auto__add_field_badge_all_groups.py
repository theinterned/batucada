...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.all_groups'
        db.add_column('badges_badge', 'all_groups', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.all_groups'
        db.delete_column('badges_badge', 'all_groups')
