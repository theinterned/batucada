...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Logic.min_avg_rating'
        db.add_column('badges_logic', 'min_avg_rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=3), keep_default=False)
        ...
        # Adding field 'Progress.current_rating'
        db.add_column('badges_progress', 'current_rating', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Logic.min_avg_rating'
        db.delete_column('badges_logic', 'min_avg_rating')
        ...
        # Deleting field 'Progress.current_rating'
        db.delete_column('badges_progress', 'current_rating')
