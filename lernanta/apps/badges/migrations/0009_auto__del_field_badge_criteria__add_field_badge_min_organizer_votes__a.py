...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('badges_badge', 'criteria', self.gf('django.db.models.fields.CharField')(default='', max_length=225), keep_default=False)
    ...
    models = {
        ...
        'badges.badge': {
            ...
            'min_organizer_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'min_peer_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
