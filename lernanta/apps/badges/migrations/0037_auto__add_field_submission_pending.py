...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.pending'
        db.add_column('badges_submission', 'pending', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.pending'
        db.delete_column('badges_submission', 'pending')
