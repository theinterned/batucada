...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('badges_badge', 'group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='badges', null=True, to=orm['projects.Project']), keep_default=False)
    ...
    models = {
        ...
        'badges.badge': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'badges'", 'null': 'True', 'to': "orm['projects.Project']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
