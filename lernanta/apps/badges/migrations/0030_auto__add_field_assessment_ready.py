...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assessment.ready'
        db.add_column('badges_assessment', 'ready', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assessment.ready'
        db.delete_column('badges_assessment', 'ready')
