...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Logic.min_qualified_votes'
        db.delete_column('badges_logic', 'min_qualified_votes')

        # Deleting field 'Logic.min_qualified_adopter_votes'
        db.delete_column('badges_logic', 'min_qualified_adopter_votes')

        # Deleting field 'Logic.min_rating'
        db.delete_column('badges_logic', 'min_rating')

        # Adding field 'Logic.min_adopter_votes'
        db.add_column('badges_logic', 'min_adopter_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Logic.min_votes'
        db.add_column('badges_logic', 'min_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Logic.min_weighted_avg_rating'
        db.add_column('badges_logic', 'min_weighted_avg_rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=3), keep_default=False)

        # Deleting field 'Progress.current_qualified_ratings'
        db.delete_column('badges_progress', 'current_qualified_ratings')

        # Adding field 'Progress.current_adopter_votes'
        db.add_column('badges_progress', 'current_adopter_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Progress.current_votes'
        db.add_column('badges_progress', 'current_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Progress.current_weighted_rating'
        db.add_column('badges_progress', 'current_weighted_rating', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Logic.min_qualified_votes'
        db.add_column('badges_logic', 'min_qualified_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Logic.min_qualified_adopter_votes'
        db.add_column('badges_logic', 'min_qualified_adopter_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Logic.min_rating'
        db.add_column('badges_logic', 'min_rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=3), keep_default=False)

        # Deleting field 'Logic.min_adopter_votes'
        db.delete_column('badges_logic', 'min_adopter_votes')

        # Deleting field 'Logic.min_votes'
        db.delete_column('badges_logic', 'min_votes')

        # Deleting field 'Logic.min_weighted_avg_rating'
        db.delete_column('badges_logic', 'min_weighted_avg_rating')

        # Adding field 'Progress.current_qualified_ratings'
        db.add_column('badges_progress', 'current_qualified_ratings', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Deleting field 'Progress.current_adopter_votes'
        db.delete_column('badges_progress', 'current_adopter_votes')

        # Deleting field 'Progress.current_votes'
        db.delete_column('badges_progress', 'current_votes')

        # Deleting field 'Progress.current_weighted_rating'
        db.delete_column('badges_progress', 'current_weighted_rating')
    ...
    models = {
        ...
        'badges.logic': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'min_adopter_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'min_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'min_weighted_avg_rating': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3'})
        },
        'badges.progress': {
            'Meta': {'object_name': 'Progress'},
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'progresses'", 'to': "orm['badges.Badge']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'current_adopter_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'current_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'current_weighted_rating': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
