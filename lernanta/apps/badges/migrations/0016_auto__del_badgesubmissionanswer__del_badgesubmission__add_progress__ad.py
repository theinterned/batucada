...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('badges_progress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='progresses', to=orm['badges.Badge'])),
            ('current_qualified_ratings', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ...
        db.send_create_signal('badges', ['Progress'])

        # Adding model 'Rating'
        db.create_table('badges_rating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('score', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('rubric', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratings', to=orm['badges.Rubric'])),
            ('assessor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratings', to=orm['users.UserProfile'])),
        ))
        db.send_create_signal('badges', ['Rating'])

        # Adding model 'Assessment'
        db.create_table('badges_assessment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('final_rating', self.gf('django.db.models.fields.FloatField')(default=1)),
            ('assessor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assessments', to=orm['users.UserProfile'])),
            ('assessed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='badge_assessments', to=orm['users.UserProfile'])),
            ('comment', self.gf('richtext.models.RichTextField')()),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assessments', to=orm['badges.Badge'])),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assessments', null=True, to=orm['badges.Submission'])),
        ))
        db.send_create_signal('badges', ['Assessment'])

        # Adding M2M table for field ratings on 'Assessment'
        db.create_table('badges_assessment_ratings', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('assessment', models.ForeignKey(orm['badges.assessment'], null=False)),
            ('rating', models.ForeignKey(orm['badges.rating'], null=False))
        ))
        db.create_unique('badges_assessment_ratings', ['assessment_id', 'rating_id'])

        # Adding model 'Submission'
        db.create_table('badges_submission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('richtext.models.RichTextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', to=orm['users.UserProfile'])),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', to=orm['badges.Badge'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('badges', ['Submission'])

        # Adding field 'Award.submission'
        db.add_column('badges_award', 'submission', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='awards', null=True, to=orm['badges.Submission']), keep_default=False)

        # Adding field 'Award.assessment'
        db.add_column('badges_award', 'assessment', self.gf('django.db.models.fields.related.ForeignKey')(default=3, related_name='awards', to=orm['badges.Assessment']), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'BadgeSubmissionAnswer'
        db.create_table('badges_badgesubmissionanswer', (
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', to=orm['badges.BadgeSubmission'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', to=orm['users.UserProfile'])),
            ('text', self.gf('richtext.models.RichTextField')()),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('badges', ['BadgeSubmissionAnswer'])

        # Adding model 'BadgeSubmission'
        db.create_table('badges_badgesubmission', (
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='badge_application', to=orm['projects.Project'])),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='badge_application', to=orm['badges.Badge'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('badges', ['BadgeSubmission'])

        # Deleting model 'Progress'
        db.delete_table('badges_progress')

        # Deleting model 'Rating'
        db.delete_table('badges_rating')

        # Deleting model 'Assessment'
        db.delete_table('badges_assessment')

        # Removing M2M table for field ratings on 'Assessment'
        db.delete_table('badges_assessment_ratings')

        # Deleting model 'Submission'
        db.delete_table('badges_submission')

        # Deleting field 'Award.submission'
        db.delete_column('badges_award', 'submission_id')

        # Deleting field 'Award.assessment'
        db.delete_column('badges_award', 'assessment_id')
    ...
    models = {
        ...
        'badges.assessment': {
            ...
            'final_rating': ('django.db.models.fields.FloatField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ratings': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'assessments'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['badges.Rating']"}),
        ...
        'badges.award': {
            ...
            'assessment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'awards'", 'to': "orm['badges.Assessment']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'awards'", 'null': 'True', 'to': "orm['badges.Submission']"}),
        ...
        'badges.badge': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'badges'", 'to': "orm['users.UserProfile']"}),
        ...
        'badges.logic': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'min_qualified_adopter_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'min_qualified_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'min_rating': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3'})
        },
        'badges.progress': {
            ...
            'current_qualified_ratings': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'badges.rating': {
            ...
            'assessor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ratings'", 'to': "orm['users.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
