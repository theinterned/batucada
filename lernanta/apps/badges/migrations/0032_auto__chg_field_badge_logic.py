...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.logic'
        db.alter_column('badges_badge', 'logic_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['badges.Logic']))


    def backwards(self, orm):
        
        # Changing field 'Badge.logic'
        db.alter_column('badges_badge', 'logic_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['badges.Logic']))
