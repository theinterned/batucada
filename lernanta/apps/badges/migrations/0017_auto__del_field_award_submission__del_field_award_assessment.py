...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('badges_award', 'submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='awards', null=True, to=orm['badges.Submission'], blank=True), keep_default=False)

        # Adding field 'Award.assessment'
        db.add_column('badges_award', 'assessment', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='awards', to=orm['badges.Assessment']), keep_default=False)
