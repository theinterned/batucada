...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badge.creator'
        db.add_column('badges_badge', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='badges', to=orm['users.UserProfile']), keep_default=False)

        # Adding field 'Badge.last_update'
        db.add_column('badges_badge', 'last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 9, 25), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.creator'
        db.delete_column('badges_badge', 'creator_id')

        # Deleting field 'Badge.last_update'
        db.delete_column('badges_badge', 'last_update')
