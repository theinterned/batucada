...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assessment.weight'
        db.add_column('badges_assessment', 'weight', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Changing field 'Assessment.final_rating'
        db.alter_column('badges_assessment', 'final_rating', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Deleting field 'Assessment.weight'
        db.delete_column('badges_assessment', 'weight')

        # Changing field 'Assessment.final_rating'
        db.alter_column('badges_assessment', 'final_rating', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        'badges.assessment': {
            ...
            'final_rating': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
