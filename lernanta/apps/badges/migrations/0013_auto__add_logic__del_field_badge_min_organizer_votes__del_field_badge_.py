...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Logic'
        db.create_table('badges_logic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('min_qualified_adopter_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('min_qualified_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('min_rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=3)),
        ))
        db.send_create_signal('badges', ['Logic'])

        # Deleting field 'Badge.min_organizer_votes'
        db.delete_column('badges_badge', 'min_organizer_votes')

        # Deleting field 'Badge.min_peer_votes'
        db.delete_column('badges_badge', 'min_peer_votes')

        # Deleting field 'Badge.min_rating'
        db.delete_column('badges_badge', 'min_rating')

        # Adding field 'Badge.logic'
        db.add_column('badges_badge', 'logic', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='badges', null=True, to=orm['badges.Logic']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Logic'
        db.delete_table('badges_logic')

        # Adding field 'Badge.min_organizer_votes'
        db.add_column('badges_badge', 'min_organizer_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Badge.min_peer_votes'
        db.add_column('badges_badge', 'min_peer_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Badge.min_rating'
        db.add_column('badges_badge', 'min_rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=3), keep_default=False)

        # Deleting field 'Badge.logic'
        db.delete_column('badges_badge', 'logic_id')
