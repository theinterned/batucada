...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Activity.target_user'
        db.delete_column('activity_activity', 'target_user_id')


    def backwards(self, orm):
        
        # Adding field 'Activity.target_user'
        db.add_column('activity_activity', 'target_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target_user', null=True, to=orm['users.UserProfile']), keep_default=False)
