...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('activity_activity', 'status_id')


    def backwards(self, orm):
        
        # Adding field 'Activity.status'
        db.add_column('activity_activity', 'status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity', null=True, to=orm['statuses.Status']), keep_default=False)
