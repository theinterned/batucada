...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Activity.remote_object'
        db.delete_column('activity_activity', 'remote_object_id')


    def backwards(self, orm):
        
        # Adding field 'Activity.remote_object'
        db.add_column('activity_activity', 'remote_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activity.RemoteObject'], null=True), keep_default=False)
