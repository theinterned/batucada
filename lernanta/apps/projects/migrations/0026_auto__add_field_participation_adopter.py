...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participation.adopter'
        db.add_column('projects_participation', 'adopter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participation.adopter'
        db.delete_column('projects_participation', 'adopter')
