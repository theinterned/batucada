...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PerUserTaskCompletion.url'
        db.add_column('projects_perusertaskcompletion', 'url', self.gf('django.db.models.fields.URLField')(max_length=1023, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PerUserTaskCompletion.url'
        db.delete_column('projects_perusertaskcompletion', 'url')
