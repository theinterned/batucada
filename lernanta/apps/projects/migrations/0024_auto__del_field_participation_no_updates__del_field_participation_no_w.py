...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Participation.no_updates'
        db.delete_column('projects_participation', 'no_updates')

        # Deleting field 'Participation.no_wall_updates'
        db.delete_column('projects_participation', 'no_wall_updates')

        # Adding field 'Participation.no_organizers_wall_updates'
        db.add_column('projects_participation', 'no_organizers_wall_updates', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participation.no_organizers_content_updates'
        db.add_column('projects_participation', 'no_organizers_content_updates', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participation.no_participants_wall_updates'
        db.add_column('projects_participation', 'no_participants_wall_updates', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participation.no_participants_content_updates'
        db.add_column('projects_participation', 'no_participants_content_updates', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Participation.no_updates'
        db.add_column('projects_participation', 'no_updates', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Participation.no_wall_updates'
        db.add_column('projects_participation', 'no_wall_updates', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Participation.no_organizers_wall_updates'
        db.delete_column('projects_participation', 'no_organizers_wall_updates')

        # Deleting field 'Participation.no_organizers_content_updates'
        db.delete_column('projects_participation', 'no_organizers_content_updates')

        # Deleting field 'Participation.no_participants_wall_updates'
        db.delete_column('projects_participation', 'no_participants_wall_updates')

        # Deleting field 'Participation.no_participants_content_updates'
        db.delete_column('projects_participation', 'no_participants_content_updates')
