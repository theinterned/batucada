...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.duration_hours'
        db.add_column('projects_project', 'duration_hours', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Project.duration_minutes'
        db.add_column('projects_project', 'duration_minutes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.duration_hours'
        db.delete_column('projects_project', 'duration_hours')

        # Deleting field 'Project.duration_minutes'
        db.delete_column('projects_project', 'duration_minutes')
