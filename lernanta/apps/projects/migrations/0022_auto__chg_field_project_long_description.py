...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.long_description'
        db.alter_column('projects_project', 'long_description', self.gf('richtext.models.RichTextField')())


    def backwards(self, orm):
        
        # Changing field 'Project.long_description'
        db.alter_column('projects_project', 'long_description', self.gf('django.db.models.fields.TextField')())
