...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PerUserTaskCompletion'
        db.create_table('projects_perusertaskcompletion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='peruser_task_completion', to=orm['users.UserProfile'])),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='peruser_task_completion', to=orm['content.Page'])),
            ('checked_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('unchecked_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('projects', ['PerUserTaskCompletion'])


    def backwards(self, orm):
        
        # Deleting model 'PerUserTaskCompletion'
        db.delete_table('projects_perusertaskcompletion')
