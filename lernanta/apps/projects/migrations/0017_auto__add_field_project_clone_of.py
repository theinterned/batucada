...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.clone_of'
        db.add_column('projects_project', 'clone_of', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='derivated_projects', null=True, to=orm['projects.Project']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.clone_of'
        db.delete_column('projects_project', 'clone_of_id')
