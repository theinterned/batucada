...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field next_projects on 'Project'
        db.create_table('projects_project_next_projects', (
        ...
        db.create_unique('projects_project_next_projects', ['from_project_id', 'to_project_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field next_projects on 'Project'
        db.delete_table('projects_project_next_projects')
