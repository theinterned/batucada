...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.not_listed'
        db.add_column('projects_project', 'not_listed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Project.archived'
        db.add_column('projects_project', 'archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.not_listed'
        db.delete_column('projects_project', 'not_listed')

        # Deleting field 'Project.archived'
        db.delete_column('projects_project', 'archived')
