...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('projects_project', 'kind')

        # Adding field 'Project.category'
        db.add_column('projects_project', 'category', self.gf('django.db.models.fields.CharField')(default='study group', max_length=30, null=True), keep_default=False)

        # Adding field 'Project.other'
        db.add_column('projects_project', 'other', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'Project.other_description'
        db.add_column('projects_project', 'other_description', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Project.kind'
        db.add_column('projects_project', 'kind', self.gf('django.db.models.fields.CharField')(default='study group', max_length=30), keep_default=False)

        # Deleting field 'Project.category'
        db.delete_column('projects_project', 'category')

        # Deleting field 'Project.other'
        db.delete_column('projects_project', 'other')

        # Deleting field 'Project.other_description'
        db.delete_column('projects_project', 'other_description')
