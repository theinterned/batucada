...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.preflang'
        db.add_column('users_userprofile', 'preflang', self.gf('django.db.models.fields.CharField')(default='es', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.preflang'
        db.delete_column('users_userprofile', 'preflang')
