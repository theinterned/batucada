...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field declined on 'School'
        db.delete_table('schools_school_declined')


    def backwards(self, orm):
        
        # Adding M2M table for field declined on 'School'
        db.create_table('schools_school_declined', (
        ...
        db.create_unique('schools_school_declined', ['school_id', 'project_id'])
