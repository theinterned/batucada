...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('schools_school', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'School.short_name'
        db.alter_column('schools_school', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=15))
