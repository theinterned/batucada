...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.sidebar_width'
        db.add_column('schools_school', 'sidebar_width', self.gf('django.db.models.fields.CharField')(default='245px', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.sidebar_width'
        db.delete_column('schools_school', 'sidebar_width')
