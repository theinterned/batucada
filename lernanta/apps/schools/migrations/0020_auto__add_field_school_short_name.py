...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('schools_school', 'short_name', self.gf('django.db.models.fields.CharField')(default='WEBCRAFT', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.short_name'
        db.delete_column('schools_school', 'short_name')
