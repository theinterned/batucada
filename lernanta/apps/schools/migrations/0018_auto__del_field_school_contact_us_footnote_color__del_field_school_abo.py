...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'School.contact_us_footnote_color'
        db.delete_column('schools_school', 'contact_us_footnote_color')

        # Deleting field 'School.about_us_footnote_color'
        db.delete_column('schools_school', 'about_us_footnote_color')

        # Deleting field 'School.license_info_footnote_color'
        db.delete_column('schools_school', 'license_info_footnote_color')


    def backwards(self, orm):
        
        # Adding field 'School.contact_us_footnote_color'
        db.add_column('schools_school', 'contact_us_footnote_color', self.gf('django.db.models.fields.CharField')(default='#4cebe2', max_length=7), keep_default=False)

        # Adding field 'School.about_us_footnote_color'
        db.add_column('schools_school', 'about_us_footnote_color', self.gf('django.db.models.fields.CharField')(default='#cef200', max_length=7), keep_default=False)

        # Adding field 'School.license_info_footnote_color'
        db.add_column('schools_school', 'license_info_footnote_color', self.gf('django.db.models.fields.CharField')(default='#ffde00', max_length=7), keep_default=False)
    ...
    models = {
        ...
        'schools.school': {
            ...
            'extra_styles': ('django.db.models.fields.TextField', [], {}),
