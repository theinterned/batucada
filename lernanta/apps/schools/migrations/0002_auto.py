...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field organizers on 'School'
        db.create_table('schools_school_organizers', (
        ...
        db.create_unique('schools_school_organizers', ['school_id', 'userprofile_id'])

        # Adding M2M table for field featured on 'School'
        db.create_table('schools_school_featured', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('school', models.ForeignKey(orm['schools.school'], null=False)),
            ('project', models.ForeignKey(orm['projects.project'], null=False))
        ))
        db.create_unique('schools_school_featured', ['school_id', 'project_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field organizers on 'School'
        db.delete_table('schools_school_organizers')

        # Removing M2M table for field featured on 'School'
        db.delete_table('schools_school_featured')
