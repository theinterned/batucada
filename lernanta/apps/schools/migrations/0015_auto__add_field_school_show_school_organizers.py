...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.show_school_organizers'
        db.add_column('schools_school', 'show_school_organizers', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.show_school_organizers'
        db.delete_column('schools_school', 'show_school_organizers')
