...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.extra_styles'
        db.add_column('schools_school', 'extra_styles', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.extra_styles'
        db.delete_column('schools_school', 'extra_styles')
