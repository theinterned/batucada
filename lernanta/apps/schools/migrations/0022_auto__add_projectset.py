...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schools_projectset', (
            ...
            ('description', self.gf('richtext.models.RichTextField')()),
            ('short_description', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_sets', null=True, to=orm['schools.School'])),
            ('first_project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='starting_project_sets', null=True, to=orm['projects.Project'])),
            ('featured', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('schools', ['ProjectSet'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('schools_projectset')
    ...
    models = {
        ...
        'schools.projectset': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'projects': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'projectsets'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['projects.Project']"}),
