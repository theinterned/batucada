...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.old_term_name'
        db.add_column('schools_school', 'old_term_name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.old_term_name'
        db.delete_column('schools_school', 'old_term_name')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'imported_from_node': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
