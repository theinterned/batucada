...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectSetIndex'
        db.create_table('schools_projectsetindex', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('projectset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.ProjectSet'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('index', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('schools', ['ProjectSetIndex'])

        # Removing M2M table for field projects on 'ProjectSet'
        db.delete_table('schools_projectset_projects')


    def backwards(self, orm):
        
        # Deleting model 'ProjectSetIndex'
        db.delete_table('schools_projectsetindex')

        # Adding M2M table for field projects on 'ProjectSet'
        db.create_table('schools_projectset_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('projectset', models.ForeignKey(orm['schools.projectset'], null=False)),
            ('project', models.ForeignKey(orm['projects.project'], null=False))
        ))
        db.create_unique('schools_projectset_projects', ['projectset_id', 'project_id'])
    ...
    models = {
        ...
        'schools.projectset': {
            ...
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'first_project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'starting_project_sets'", 'null': 'True', 'to': "orm['projects.Project']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'projects': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projectsets'", 'to': "orm['projects.Project']", 'through': "orm['schools.ProjectSetIndex']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'project_sets'", 'null': 'True', 'to': "orm['schools.School']"}),
            'short_description': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '50', 'blank': 'True'})
        },
        'schools.projectsetindex': {
            'Meta': {'object_name': 'ProjectSetIndex'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.IntegerField', [], {}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"}),
            'projectset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schools.ProjectSet']"})
        },
        'schools.school': {
