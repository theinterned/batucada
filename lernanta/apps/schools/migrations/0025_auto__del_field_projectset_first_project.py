...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProjectSet.first_project'
        db.delete_column('schools_projectset', 'first_project_id')


    def backwards(self, orm):
        
        # Adding field 'ProjectSet.first_project'
        db.add_column('schools_projectset', 'first_project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='starting_project_sets', null=True, to=orm['projects.Project'], blank=True), keep_default=False)
