...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.mentor_form_url'
        db.add_column('schools_school', 'mentor_form_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'School.mentee_form_url'
        db.add_column('schools_school', 'mentee_form_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.mentor_form_url'
        db.delete_column('schools_school', 'mentor_form_url')

        # Deleting field 'School.mentee_form_url'
        db.delete_column('schools_school', 'mentee_form_url')
