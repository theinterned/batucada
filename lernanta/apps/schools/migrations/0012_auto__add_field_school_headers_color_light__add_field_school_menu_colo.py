...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.headers_color_light'
        db.add_column('schools_school', 'headers_color_light', self.gf('django.db.models.fields.CharField')(default='#F08C00', max_length=7), keep_default=False)

        # Adding field 'School.menu_color_light'
        db.add_column('schools_school', 'menu_color_light', self.gf('django.db.models.fields.CharField')(default='#4BD2C9', max_length=7), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.headers_color_light'
        db.delete_column('schools_school', 'headers_color_light')

        # Deleting field 'School.menu_color_light'
        db.delete_column('schools_school', 'menu_color_light')
