...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.more_info'
        db.add_column('schools_school', 'more_info', self.gf('richtext.models.RichTextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.more_info'
        db.delete_column('schools_school', 'more_info')
