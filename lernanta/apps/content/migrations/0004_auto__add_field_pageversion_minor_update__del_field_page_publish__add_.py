...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageVersion.minor_update'
        db.add_column('content_pageversion', 'minor_update', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Page.publish'
        db.delete_column('content_page', 'publish')

        # Adding field 'Page.minor_update'
        db.add_column('content_page', 'minor_update', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageVersion.minor_update'
        db.delete_column('content_pageversion', 'minor_update')

        # Adding field 'Page.publish'
        db.add_column('content_page', 'publish', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Page.minor_update'
        db.delete_column('content_page', 'minor_update')
