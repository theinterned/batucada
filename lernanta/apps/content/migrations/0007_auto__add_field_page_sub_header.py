...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.sub_header'
        db.add_column('content_page', 'sub_header', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.sub_header'
        db.delete_column('content_page', 'sub_header')
