...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageVersion.sub_header'
        db.add_column('content_pageversion', 'sub_header', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageVersion.sub_header'
        db.delete_column('content_pageversion', 'sub_header')
