...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field badges_to_apply on 'Page'
        db.create_table('content_page_badges_to_apply', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('page', models.ForeignKey(orm['content.page'], null=False)),
            ('badge', models.ForeignKey(orm['badges.badge'], null=False))
        ))
        db.create_unique('content_page_badges_to_apply', ['page_id', 'badge_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field badges_to_apply on 'Page'
        db.delete_table('content_page_badges_to_apply')
