...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoogleAnalyticsTrackingCode.adwords_conversion_label'
        db.add_column('tracker_googleanalyticstrackingcode', 'adwords_conversion_label', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GoogleAnalyticsTrackingCode.adwords_conversion_label'
        db.delete_column('tracker_googleanalyticstrackingcode', 'adwords_conversion_label')
