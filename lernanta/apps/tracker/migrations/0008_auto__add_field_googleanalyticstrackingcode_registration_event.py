...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoogleAnalyticsTrackingCode.registration_event'
        db.add_column('tracker_googleanalyticstrackingcode', 'registration_event', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GoogleAnalyticsTrackingCode.registration_event'
        db.delete_column('tracker_googleanalyticstrackingcode', 'registration_event')
