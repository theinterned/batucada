...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageView.user_agent'
        db.add_column('tracker_pageview', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageView.user_agent'
        db.delete_column('tracker_pageview', 'user_agent')
