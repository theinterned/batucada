...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoogleAnalyticsTrackingCode.logged_in_status'
        db.add_column('tracker_googleanalyticstrackingcode', 'logged_in_status', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GoogleAnalyticsTrackingCode.logged_in_status'
        db.delete_column('tracker_googleanalyticstrackingcode', 'logged_in_status')
