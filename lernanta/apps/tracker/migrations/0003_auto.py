...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'PageView', fields ['session_key']
        db.create_index('tracker_pageview', ['session_key'])


    def backwards(self, orm):
        
        # Removing index on 'PageView', fields ['session_key']
        db.delete_index('tracker_pageview', ['session_key'])
