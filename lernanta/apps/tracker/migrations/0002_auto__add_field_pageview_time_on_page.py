...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageView.time_on_page'
        db.add_column('tracker_pageview', 'time_on_page', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PageView.time_on_page'
        db.delete_column('tracker_pageview', 'time_on_page')
