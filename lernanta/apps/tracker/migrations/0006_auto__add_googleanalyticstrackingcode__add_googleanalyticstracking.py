...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GoogleAnalyticsTrackingCode'
        db.create_table('tracker_googleanalyticstrackingcode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
            ('code', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
        ))
        db.send_create_signal('tracker', ['GoogleAnalyticsTrackingCode'])

        # Adding model 'GoogleAnalyticsTracking'
        db.create_table('tracker_googleanalyticstracking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tracking_code', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trackings', to=orm['tracker.GoogleAnalyticsTrackingCode'])),
            ('target_content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True)),
            ('target_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
        ))
        db.send_create_signal('tracker', ['GoogleAnalyticsTracking'])


    def backwards(self, orm):
        
        # Deleting model 'GoogleAnalyticsTrackingCode'
        db.delete_table('tracker_googleanalyticstrackingcode')

        # Deleting model 'GoogleAnalyticsTracking'
        db.delete_table('tracker_googleanalyticstracking')
