...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relationship.deleted'
        db.add_column('relationships_relationship', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Relationship.deleted'
        db.delete_column('relationships_relationship', 'deleted')
