...
(function () {
    ...
    Markdown.Editor = function (markdownConverter, inputId, help) {
        ...
        this.run = function () {
            ...
            panels = new PanelCollection(inputId);
            ...
            uiManager = new UIManager(inputId, panels, undoManager, previewManager, commandManager, help);
            uiManager.setUndoRedoButtonStates();
    ...
    function PanelCollection(inputId) {
        this.buttonBar = doc.getElementById(inputId + "-wmd-button-bar");
        this.preview = doc.getElementById(inputId + "-wmd-preview");
    ...
    function UIManager(inputId, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttonRow.id = inputId + "-wmd-button-row";
            ...
            var makeSpacer = function (num) {
                ...
                spacer.id = inputId + "-wmd-spacer" + num;
            ...
            if (helpOptions) {
                ...
                helpButton.id = inputId + "-wmd-help-button";
