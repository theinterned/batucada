...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Activity.project'
        db.delete_column('activity_activity', 'project_id')

        # Adding field 'Activity.scope_object'
        db.add_column('activity_activity', 'scope_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Activity.project'
        db.add_column('activity_activity', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'], null=True), keep_default=False)

        # Deleting field 'Activity.scope_object'
        db.delete_column('activity_activity', 'scope_object_id')
