...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.menu_color'
        db.add_column('schools_school', 'menu_color', self.gf('django.db.models.fields.CharField')(default='#36CDC4', max_length=7), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.menu_color'
        db.delete_column('schools_school', 'menu_color')
