...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('schools_school', 'description', self.gf('richtext.models.RichTextField')())


    def backwards(self, orm):
        
        # Changing field 'School.description'
        db.alter_column('schools_school', 'description', self.gf('django.db.models.fields.TextField')())
