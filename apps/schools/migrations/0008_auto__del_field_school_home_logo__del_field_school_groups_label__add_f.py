...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.logo'
        db.add_column('schools_school', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'School.groups_icon'
        db.add_column('schools_school', 'groups_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'School.logo'
        db.delete_column('schools_school', 'logo')

        # Deleting field 'School.groups_icon'
        db.delete_column('schools_school', 'groups_icon')
