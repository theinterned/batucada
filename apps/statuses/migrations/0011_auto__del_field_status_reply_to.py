...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('statuses_status', 'reply_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='status_replies', null=True, to=orm['activity.Activity'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'statuses.status': {
            ...
            'status': ('richtext.models.RichTextField', [], {})
        },
        'taggit.tag': {
