...
urlpatterns = patterns('',
  ...
  url(r'^profile/edit/openids/complete/$', 'users.views.profile_edit_openids_complete',
  ...
  url(r'^profile/edit/links/edit/(?P<link_id>[\d]+)/$', 'users.views.profile_edit_links_edit',
