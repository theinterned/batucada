...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_userprofile', 'bio', self.gf('richtext.models.RichTextField')())


    def backwards(self, orm):
        
        # Changing field 'UserProfile.bio'
        db.alter_column('users_userprofile', 'bio', self.gf('django.db.models.fields.TextField')())
