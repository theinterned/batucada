...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_userprofile', 'language', self.gf('django.db.models.fields.CharField')(default='en', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.language'
        db.delete_column('users_userprofile', 'language')
