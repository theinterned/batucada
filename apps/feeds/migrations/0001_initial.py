...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feeds_entry', (
            ...
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feed_entries', to=orm['projects.Link'])),
            ('signature', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('processed_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    models = {
        ...
        'feeds.entry': {
            ...
            'processed_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
