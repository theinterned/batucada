...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('challenges_submission', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    models = {
        ...
        'challenges.challenge': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 10, 6, 21, 25, 493731)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 10, 6, 21, 25, 493223)'}),
        ...
        'challenges.submission': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 10, 6, 21, 25, 497520)', 'auto_now_add': 'True', 'blank': 'True'}),
