...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('projects_project', 'sign_up', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sign_up_project', null=True, to=orm['content.Page'], blank=True), keep_default=False)
